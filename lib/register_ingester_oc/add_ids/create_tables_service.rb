  ...
  module AddIds
    class CreateTablesService
      ...
      def initialize(
        ...
        bulk_data_s3_prefix: ENV.fetch('ADD_IDS_BULK_DATA_S3_PREFIX'),
        processed_s3_location: ENV.fetch('ADD_IDS_PROCESSED_S3_LOCATION'),
        filtered_s3_location: ENV.fetch('ADD_IDS_FILTERED_S3_LOCATION')
      )
